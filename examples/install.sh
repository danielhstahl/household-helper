## example of running this script: LLM_IP=[] PSQL_USER=stahlserver DOMAIN=draid.home RELEASE_TAG=v1.2.0 GENERATE_SSL=true INSTALL_TYPE=all ./install.sh
...
if [ ${INSTALL_TYPE} == "all" ] || [ ${INSTALL_TYPE} == "ui" ]; then
